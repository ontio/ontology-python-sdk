...
class TestRpcClient(unittest.TestCase):
    ...
    def test_get_block_height_by_tx_hash(self):
        ...
        block_height = rpc.get_block_height_by_tx_hash(tx_hash)
    ...
    def test_get_block_count_by_tx_hash(self):
        tx_hash = '7e8c19fdd4f9ba67f95659833e336eac37116f74ea8bf7be4541ada05b13503e'
        block_count = rpc.get_block_count_by_tx_hash(tx_hash)
    ...
    def test_get_balance(self):
        ...
        address_balance = rpc.get_balance(acct.get_address_base58())
        try:
            address_balance['ont']
        except KeyError:
            raised = True
        ...
        multi_address_balance = rpc.get_balance(multi_addr.b58encode())
        try:
    ...
    def test_get_smart_contract_event_by_tx_hash(self):
        ...
        event = rpc.get_smart_contract_event_by_tx_hash(tx_hash)
        self.assertEqual(event['TxHash'], tx_hash)

    def test_get_smart_contract_event_by_height(self):
        height = 0
        event_list = rpc.get_smart_contract_event_by_height(height)
    ...
    def test_get_smart_contract_event_by_count(self):
        count = 1
        event_list = rpc.get_smart_contract_event_by_count(count)
        self.assertEqual(10, len(event_list))
        count = 1309738
        event_list = rpc.get_smart_contract_event_by_count(count)
        self.assertEqual(0, len(event_list))
    ...
    def test_get_transaction_by_tx_hash(self):
        tx_hash = "65d3b2d3237743f21795e344563190ccbe50e9930520b8525142b075433fdd74"
        tx = rpc.get_transaction_by_tx_hash(tx_hash)
    ...
    def test_get_smart_contract(self):
        ...
        contract = rpc.get_smart_contract(contract_address)
    ...
    def test_get_merkle_proof(self):
        ...
        merkle_proof_1 = rpc.get_merkle_proof(tx_hash_1)
        ...
        merkle_proof_2 = rpc.get_merkle_proof(tx_hash_2)
        ...
        merkle_proof_3 = rpc.get_merkle_proof(tx_hash_3)
        ...
        merkle_proof_4 = rpc.get_merkle_proof(tx_hash_4)
        ...
        merkle_proof_5 = rpc.get_merkle_proof(tx_hash_5)
        ...
        merkle_proof_6 = rpc.get_merkle_proof(tx_hash_6)
    ...
    def test_get_memory_pool_tx_state(self):
        ...
        try:
            tx_state = rpc.get_memory_pool_tx_state(tx_hash)
