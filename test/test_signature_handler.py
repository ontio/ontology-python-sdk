...
class TestSignatureHandler(unittest.TestCase):
    def test_signature_data(self):
        ...
        self.assertTrue(sdk.verify_signature(acc.get_public_key_bytes(), "sss".encode(), sig))
    ...
    def test_generate_signature(self):
        ...
        res = handler.verify_signature(acc.get_public_key_bytes(), "sss".encode(), bytearray.fromhex(sigaa))
        self.assertTrue(res)