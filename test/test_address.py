...
class TestAddress(unittest.TestCase):
    def test_address_from_vm_code(self):
        ...
        contract_hex_address = 'f2b6efc3e4360e69b8ff5db8ce8ac73651d07a12'
        self.assertEqual(contract_hex_address, code_address.to_hex_str())
        self.assertEqual(contract_hex_address, binascii.b2a_hex(code_address.to_bytes()).decode('ascii'))
        self.assertEqual(contract_hex_address, binascii.b2a_hex(code_address.to_bytearray()).decode('ascii'))
        self.assertEqual(contract_hex_address, ContractDataParser.to_reserve_hex_str(code_address.to_reverse_hex_str()))
